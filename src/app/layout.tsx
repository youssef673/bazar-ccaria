...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "decorazioni esterno",
    "Calabria",
    "vasi in ceramica Calabria",
    "statue in cemento Calabria",
    "fontane da giardino Calabria",
    "arredo giardino Cosenza",
    "arredo giardino Catanzaro",
    "arredo giardino Reggio Calabria",
  ],
